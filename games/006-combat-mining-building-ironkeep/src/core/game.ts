...
export class Game {
  ...
  private isPlayerPassable(x: number, y: number): boolean {
    ...
    return t === TILE.FLOOR || t === TILE.PROP;
  }
  ...
  /** 既に掘った床・支保工だけを通って地上(y=0)へ戻るのに必要なマス数をBFSで求める */
...
export { bandAt, requiredDrillPower, digTicksFor, oreValue, bridgeCost, barricadeCost, buildCostMultOf };
